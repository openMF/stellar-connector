...
public class InvalidConfigurationException extends RuntimeException {
  ...
  public static InvalidConfigurationException invalidInstallationAccountSecretSeed() {
    return new InvalidConfigurationException(
        "Invalid installation account secret seed.  Have your admin check configuration.");
  }

  public static InvalidConfigurationException unreachableStellarServerAddress(
